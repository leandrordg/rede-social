...
import { IoAlertCircle, IoBookmark } from "react-icons/io5";
      ...
      >
        <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="flex flex-col gap-y-2 p-2">
            ...
            <Menu.Item>
              <button className="flex w-full items-center gap-2 rounded-md p-2 hover:bg-neutral-100/50">
                <IoMdShare className="h-5 w-5 text-gray-500" />
                <span className="text-sm md:text-base">Compartilhar</span>
              </button>
            </Menu.Item>
            ...
            {isMyPost && (
              <>
                ...
                <Menu.Item>
                  <button className="flex w-full items-center gap-2 rounded-md p-2 hover:bg-neutral-100/50">
                    <RiFileLockFill className="h-5 w-5 text-gray-500" />
                    <span className="text-sm md:text-base">Arquivar</span>
                  </button>
                </Menu.Item>
              </>
            )}
